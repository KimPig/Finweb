...
import { finwebPreferences } from 'constants/finwebPreferences';
...
function saveUser(context, user, userSettingsInstance, apiClient) {
    ...
    if (finwebPreferences.displayCustomization) {
...
function embed(options, self) {
    ...
    const customization = options.element.querySelector('.finweb-display-customization');
    customization.hidden = !finwebPreferences.displayCustomization;
    customization.disabled = !finwebPreferences.displayCustomization;
