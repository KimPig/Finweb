...
function saveUser(context, user, userSettingsInstance, apiClient) {
    ...
    if (finwebPreferences.playbackAdvanced) {
...
function embed(options, self) {
    ...
    for (const group of options.element.querySelectorAll('.finweb-playback-advanced')) {
        group.hidden = !finwebPreferences.playbackAdvanced;
        group.disabled = !finwebPreferences.playbackAdvanced;
    }
