...
const LibraryToolbar: FC = () => {
    ...
    return (
        <Toolbar
            variant='dense'
            className='finweb-library-toolbar padded-left padded-right'
            sx={{
                display: 'flex',
                flexWrap: 'wrap',
                alignItems: 'center'
        ...
        >
            <Box className='finweb-library-summary' sx={{ display: 'flex', alignItems: 'center', minWidth: 0 }}>
                <LibraryViewMenu />
                ...
                {!MENU_ONLY_VIEWS.includes(viewType) && (
                    ...
                    >
                        <Chip label={itemCountDisplay} title={String(itemCountDisplay)}
                            sx={{ width: '16ch', maxWidth: '100%', fontVariantNumeric: 'tabular-nums' }} />
                    </Box>
                )}
            </Box>
            ...
            {!MENU_ONLY_VIEWS.includes(viewType) && (
                <Stack
                    className='finweb-library-actions'
                    useFlexGap
                    direction='row'
                    spacing={1}
                    sx={{
                ...
                >
                    ...
                    >
                        <ButtonGroup
                            variant='contained'
                            disabled={isPending || itemsResult?.isPlaceholderData}
