...
const ItemsView: FC = () => {
    ...
    const getItems = useCallback(() => {
        if (itemsResult?.isError) {
            return <NoItemsMessage message='ErrorDefault' />;
        }
    ...
    return (
        <Box className='padded-bottom-page'>
            ...
            <ContentLoadingBoundary
                loading={!itemsResult || itemsResult.isPending || itemsResult.isPlaceholderData}
                retainContent={itemsResult?.isPlaceholderData}
            >
                <ItemsContainer
