...
export const useGetItemsViewByType = (
    ...
    return useQuery({
        ...
        placeholderData: (previous, previousQuery) => {
            ...
            // Never retain another user's or another library's items across navigation.
            return key?.[1] === currentApi.user?.Id && key?.[3] === parentId && key?.[5] === viewType ? previous : undefined;
        },
        enabled: !!currentApi.api && !!currentApi.user?.Id
            && viewType
            && [
